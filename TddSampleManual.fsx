...
let makeTest name func = { Name = name ; Test = func }
...
[
  makeTest "Test Adding" ``test adding``
  makeTest "Test Subtraction" ``test subtraction``
  makeTest "Test Division" ``test division``
]
|> TddSupport.runTests
